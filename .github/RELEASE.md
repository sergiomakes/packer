...
This document describes how to create a new release for Packer.
...
- `packer-windows-x64.exe` - Windows executable
- `packer-linux-x64.tar.gz` - Linux binary (tarball)
- `packer-macos-universal.tar.gz` - macOS binary (tarball)
